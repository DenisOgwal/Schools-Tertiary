...
namespace College_Management_System
{
    public partial class frmSubjectInfo : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (cus.Text == "")
            {
                MessageBox.Show("Please Enter credit units", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cus.Focus();
                return;
            }
            ...
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "insert into subjectinfo(subjectcode,subjectname,coursename,branch,semester,Creditunits) VALUES (@d1,@d2,@d4,@d5,@d6,@d7)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.NChar, 10, "Creditunits"));
                ...
                cmd.Parameters["@d7"].Value = (cus.Text);
                cmd.ExecuteNonQuery();
        ...
        private void SubjectCode_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (rdr1.Read())
                {
                    SubjectName.Text = (String)rdr1["SubjectName"];
                    cmbCourse.Text = (String)rdr1["CourseName"];
                    cmbBranch.Text = (String)rdr1["Branch"];
                    Semester.Text = (String)rdr1["Semester"];
                }
                if ((rdr1 != null))
                {
                    rdr1.Close();
        ...
        private void Update_record_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update subjectinfo set subjectname=@d2,coursename=@d4,branch=@d5,semester=@d6, Creditunits=@d7 where subjectcode=@d1";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 20, "SubjectCode"));
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.VarChar, 250, "subjectname"));
        ...
        private void cus_KeyPress(object sender, KeyPressEventArgs e)
        {
