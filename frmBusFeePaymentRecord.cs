    ...
    public partial class frmBusFeePaymentRecord : Form
    {
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            {               
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Transportation.SourceLocation)[Source Location],RTRIM(BusFeePayment.BusCharges)[Bus Charges],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],RTRIM(BusFeePayment.Year)[Session] from BusFeePayment,Student,Transportation,BusHolders where Student.scholarNo=BusHolders.ScholarNo and Student.Session=BusHolders.Year and Student.Course=BusHolders.Class and BusFeePayment.ScholarNo=Student.ScholarNo and BusFeePayment.Year=Student.Session and BusFeePayment.Class=Student.Course and Transportation.SourceLocation=BusHolders.SourceLocation and DateOfPayment between @date1 and @date2 and DueFees > 0 order by DateOfPayment", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Transportation.SourceLocation)[Source Location],RTRIM(BusFeePayment.BusCharges)[Bus Charges],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],RTRIM(BusFeePayment.Year)[Session] from BusFeePayment,Student,Transportation,BusHolders where Student.scholarNo=BusHolders.ScholarNo and Student.Session=BusHolders.Year and Student.Course=BusHolders.Class and BusFeePayment.ScholarNo=Student.ScholarNo and BusFeePayment.Year=Student.Session and BusFeePayment.Class=Student.Course and Transportation.SourceLocation=BusHolders.SourceLocation and DateOfPayment between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by DateOfPayment", con);
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {         
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Transportation.SourceLocation)[Source Location],RTRIM(BusFeePayment.BusCharges)[Bus Charges],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],RTRIM(BusFeePayment.Year)[Session] from BusFeePayment,Student,Transportation,BusHolders where Student.scholarNo=BusHolders.ScholarNo and Student.Session=BusHolders.Year and Student.Course=BusHolders.Class and BusFeePayment.ScholarNo=Student.ScholarNo and BusFeePayment.Year=Student.Session and BusFeePayment.Class=Student.Course and Transportation.SourceLocation=BusHolders.SourceLocation and Student.ScholarNo = '" + ScholarNo.Text + "' order by DateOfPayment", con);             
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusFeePayment");
                myDA.Fill(myDataSet, "Transportation");
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {              
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Transportation.SourceLocation)[Source Location],RTRIM(BusFeePayment.BusCharges)[Bus Charges],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],RTRIM(BusFeePayment.Year)[Session] from BusFeePayment,Student,Transportation,BusHolders where Student.scholarNo=BusHolders.ScholarNo and Student.Session=BusHolders.Year and Student.Course=BusHolders.Class and BusFeePayment.ScholarNo=Student.ScholarNo and BusFeePayment.Year=Student.Session and BusFeePayment.Class=Student.Course and Transportation.SourceLocation=BusHolders.SourceLocation and DateOfPayment between @date1 and @date2 order by DateOfPayment", con);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            {              
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Transportation.SourceLocation)[Source Location],RTRIM(BusFeePayment.BusCharges)[Bus Charges],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],RTRIM(BusFeePayment.Year)[Session] from BusFeePayment,Student,Transportation,BusHolders where Student.scholarNo=BusHolders.ScholarNo and Student.Session=BusHolders.Year and Student.Course=BusHolders.Class and BusFeePayment.ScholarNo=Student.ScholarNo and BusFeePayment.Year=Student.Session and BusFeePayment.Class=Student.Course and Transportation.SourceLocation=BusHolders.SourceLocation and DateOfPayment between @date1 and @date2 and Fine > 0 order by DateOfPayment", con);
