    ...
    public partial class frmHostelFeePaymentRecord1 : Form
    {
        ...
        private void AutocompleteCourse()
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("SELECT distinct RTRIM(Class) FROM Hostelers", CN);
                ds = new DataSet("ds");
                adp.Fill(ds);
                dtable = ds.Tables[0];
                Course.Items.Clear();
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            {              
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(ScholarNo)[Scholar No.],RTRIM(StudentNames)[Student Name],RTRIM(Class)[Course],RTRIM(Section)[Branch],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment where DateOfPayment between @date1 and @date2 and DueFees > 0 order by DateOfPayment", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(ScholarNo)[Scholar No.],RTRIM(StudentNames)[Student Name],RTRIM(Class)[Course],RTRIM(Section)[Branch],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment where DateOfPayment between @date1 and @date2 and Class= '" + Course.Text + "' and Section='" + Branch.Text + "' order by DateOfPayment", con);
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {           
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(ScholarNo)[Scholar No.],RTRIM(StudentNames)[Student Name],RTRIM(Class)[Course],RTRIM(Section)[Branch],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment where ScholarNo = '" + ScholarNo.Text + "' order by DateOfPayment", con);       
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "HostelFeePayment");
        ...
        private void button10_Click(object sender, EventArgs e)
        {
             try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(ScholarNo)[Scholar No.],RTRIM(StudentNames)[Student Name],RTRIM(Class)[Course],RTRIM(Section)[Branch],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment where DateOfPayment between @date1 and @date2 order by DateOfPayment", con);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            {              
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(ScholarNo)[Scholar No.],RTRIM(StudentNames)[Student Name],RTRIM(Class)[Course],RTRIM(Section)[Branch],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment where DateOfPayment between @date1 and @date2 and Fine > 0 order by DateOfPayment", con);
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            frm.txtHostelFees.Text = dr.Cells[5].Value.ToString();
            ...
            frm.Term.Text = dr.Cells[13].Value.ToString();
