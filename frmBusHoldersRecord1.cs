    ...
    public partial class frmBusHoldersRecord1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Session],RTRIM(BusHolders.Term)[Semester],RTRIM(FeePayable)[Fees Payable]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and StartingDate between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by StartingDate", con);
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {           
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Session],RTRIM(BusHolders.Term)[Semester],RTRIM(FeePayable)[Fees Payable]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and Student.ScholarNo = '" + ScholarNo.Text + "' order by Student_name", con);               
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
        ...
        private void cmbStudentName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Session],RTRIM(BusHolders.Term)[Semester],RTRIM(FeePayable)[Fees Payable]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and Student_name = '" + cmbStudentName.Text + "' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
        ...
        private void txtStudentName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Session],RTRIM(BusHolders.Term)[Semester],RTRIM(FeePayable)[Fees Payable]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and Student_name like '" + txtStudentName.Text + "%' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Session],RTRIM(BusHolders.Term)[Semester],RTRIM(FeePayable)[Fees Payable]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and StartingDate between @date1 and @date2 order by StartingDate", con);
        ...
        private void txtSourceLocation_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Session],RTRIM(BusHolders.Term)[Semester],RTRIM(FeePayable)[Fees Payable]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and SourceLocation like '" + txtSourceLocation.Text + "%' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
        ...
        private void cmbSourceLocation_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(SourceLocation)[Source Location], RTRIM(StartingDate)[Starting Date],RTRIM(BusHolders.Year)[Session],RTRIM(BusHolders.Term)[Semester],RTRIM(FeePayable)[Fees Payable]  from BusHolders,Student where Student.ScholarNo=BusHolders.ScholarNo and Student.Course=BusHolders.Class and Student.Session=BusHolders.Year and SourceLocation = '" + cmbSourceLocation.Text + "' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "BusHolders");
                myDA.Fill(myDataSet, "Student");
