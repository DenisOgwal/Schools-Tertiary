...
{
    public partial class frnLibraryDepartmentRecord : Form
    {
        ConnectionString cs = new ConnectionString();

        public frnLibraryDepartmentRecord()
        {
            InitializeComponent();
        }
        ...
        {
            dynamic SelectQry = "SELECT RTRIM(AcademicDepartments)[Department] FROM AcademicUnits";
