    ...
    public partial class frmHostelersRecord1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Room No.],RTRIM(Year)[Session],RTRIM(FeePayable)[Fees Payable] from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and JoiningDate between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by JoiningDate", con);
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {     
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Room No.],RTRIM(Year)[Session],RTRIM(FeePayable)[Fees Payable] from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and Student.ScholarNo = '" + ScholarNo.Text + "' order by Student_name", con);    
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
                myDA.Fill(myDataSet, "Student");
        ...
        private void cmbStudentName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Room No.],RTRIM(Year)[Semester],RTRIM(FeePayable)[Fees Payable] from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and Student_name = '" + cmbStudentName.Text + "' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
                myDA.Fill(myDataSet, "Student");
        ...
        private void txtStudentName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Room No.],RTRIM(Year)[Semester],RTRIM(FeePayable)[Fees Payable] from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and Student_name like '" + txtStudentName.Text + "%' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
                myDA.Fill(myDataSet, "Student");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Room No.],RTRIM(Year)[Session],RTRIM(FeePayable)[Fees Payable] from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and JoiningDate between @date1 and @date2 order by JoiningDate", con);
        ...
        private void cmbHostelName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Room No.],RTRIM(Year)[Session],RTRIM(FeePayable)[Fees Payable] from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and HostelName = '" + cmbHostelName.Text + "' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
                myDA.Fill(myDataSet, "Student");
        ...
        private void txtHostelName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(Student.ScholarNo)[ScholarNo],RTRIM(Student_name)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(HostelName)[Hostel Name], RTRIM(JoiningDate)[Joining Date], RTRIM(BedNo)[ Room No.],RTRIM(Year)[Session],RTRIM(FeePayable)[Fees Payable] from Hostelers,Student where Student.ScholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and HostelName like '" + txtHostelName.Text + "%' order by Student_name", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "Hostelers");
                myDA.Fill(myDataSet, "Student");
