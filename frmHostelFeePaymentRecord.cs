    ...
    public partial class frmHostelFeePaymentRecord : Form
    {
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            {         
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and HostelFeePayment.ScholarNo=Student.ScholarNo and HostelFeePayment.Class=Student.Course and HostelFeePayment.Year=Student.Session and Hostel.HostelName=Hostelers.Hostelname and DateOfPayment between @date1 and @date2 and DueFees > 0 order by DateOfPayment", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and HostelFeePayment.ScholarNo=Student.ScholarNo and HostelFeePayment.Class=Student.Course and HostelFeePayment.Year=Student.Session and Hostel.HostelName=Hostelers.Hostelname and DateOfPayment between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by DateOfPayment", con);
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {   
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and HostelFeePayment.ScholarNo=Student.ScholarNo and HostelFeePayment.Class=Student.Course and HostelFeePayment.Year=Student.Session and Hostel.HostelName=Hostelers.Hostelname and Student.ScholarNo = '" + ScholarNo.Text + "' order by DateOfPayment", con);
                SqlDataAdapter myDA = new SqlDataAdapter(cmd);
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "HostelFeePayment");
                myDA.Fill(myDataSet, "Hostel");
        ...
        private void button10_Click(object sender, EventArgs e)
        {
             try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and HostelFeePayment.ScholarNo=Student.ScholarNo and HostelFeePayment.Class=Student.Course and HostelFeePayment.Year=Student.Session and Hostel.HostelName=Hostelers.Hostelname and DateOfPayment between @date1 and @date2 order by DateOfPayment", con);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            {          
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select RTrim(HFeePaymentID)[Fee Payment ID], RTRIM(Student.ScholarNo)[Scholar No.],RTRIM(Student_name)[Student Name],RTRIM(Student.Course)[Course],RTRIM(Branch)[Branch],RTRIM(Hostel.HostelName)[Hostel Name],RTRIM(HostelFeePayment.HostelFees1)[Hostel Fees],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees],(HostelFeePayMent.Year)[Session],(HostelFeePayMent.Term)[Semester] from HostelFeePayment,Student,Hostel,Hostelers where Student.scholarNo=Hostelers.ScholarNo and Student.Session=Hostelers.Year and Student.Course=Hostelers.Class and HostelFeePayment.ScholarNo=Student.ScholarNo and HostelFeePayment.Class=Student.Course and HostelFeePayment.Year=Student.Session and Hostel.HostelName=Hostelers.Hostelname and DateOfPayment between @date1 and @date2 and Fine > 0 order by DateOfPayment", con);
