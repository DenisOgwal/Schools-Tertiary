    ...
    public partial class frmScholarshipPaymentRecord1 : Form
    {
        ...
        private void Course_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                string ct = "select distinct RTRIM(Section) from ScholarshipPayment where  Class= '" + Course.Text + "'";
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarshipPaymentID)[Scholarship Payment ID],RTRIM(ScholarshipPayment.ScholarshipID)[Scholarship ID],RTRIM(ScholarshipName)[Scholarship Name],RTRIM(ScholarshipPayment.Amount)[Scholarship Amount],RTRIM(ScholarNo)[Scholar No.], RTRIM(StudentNames)[Student Name],RTRIM(Class)[Course],RTRIM(Section)[Branch],RTRIM(PaymentDate)[Payment Date],RTRIM(PaymentMode)[Payment Mode],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Student Payable],RTRIM(DuePayment)[Student Due Payment],RTRIM(Year)[Session],RTRIM(ScholarshipPayment.Term)[Semester] from ScholarshipPayment,Scholarship where Scholarship.ScholarshipID=ScholarshipPayment.ScholarshipID and ScholarshipPayment.ScholarNo= '" + ScholarNo.Text + "' order by PaymentDate", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                cmd = new SqlCommand("select  RTrim(ScholarshipPaymentID)[Scholarship Payment ID],RTRIM(ScholarshipPayment.ScholarshipID)[Scholarship ID],RTRIM(ScholarshipName)[Scholarship Name],RTRIM(ScholarshipPayment.Amount)[Scholarship Amount],RTRIM(ScholarNo)[Scholar No.], RTRIM(StudentNames)[Student Name],RTRIM(Class)[Course],RTRIM(Section)[Branch],RTRIM(PaymentDate)[Payment Date],RTRIM(PaymentMode)[Payment Mode],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Student Payable],RTRIM(DuePayment)[Student Due Payment],RTRIM(Year)[Session],RTRIM(ScholarshipPayment.Term)[Semester] from ScholarshipPayment,Scholarship where Scholarship.ScholarshipID=ScholarshipPayment.ScholarshipID and PaymentDate between @date1 and @date2 and Class= '" + Course.Text + "' and Section='" + Branch.Text + "' order by PaymentDate", con);
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                frm.Term.Text = dr.Cells[14].Value.ToString();
                ...
                frm.scholardiscount.Text = dr.Cells[3].Value.ToString();
                frm.Amount.Text = dr.Cells[11].Value.ToString();
