...
{
    public partial class frmLibrarySectionsRecord : Form
    {
        ConnectionString cs = new ConnectionString();

        public frmLibrarySectionsRecord()
        {
            InitializeComponent();
        }
        ...
        {
            dynamic SelectQry = "SELECT RTRIM(Sectionname)[Section] FROM LibrarySections";
