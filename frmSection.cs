    ...
    public partial class frmSection : Form
    {
        ...
        private void frmSection_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (rdr.Read())
                {
                    ...
                    if (pricess == "Yes") { btnUpdate.Enabled = true; } else { btnUpdate.Enabled = false; }
                }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 40, "sectionname"));
                cmd.Parameters.Add(new SqlParameter("@d3", System.Data.SqlDbType.NChar, 50, "course"));
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 40, "sectionname"));
                cmd.Parameters.Add(new SqlParameter("@d3", System.Data.SqlDbType.NChar, 39, "course"));
                cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.NChar, 30, "branch"));
