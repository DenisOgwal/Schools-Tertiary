...
namespace College_Management_System
{
    public partial class frmFeesDetailsRecord : Form
    {
        ...
        {
            dynamic SelectQry = "SELECT RTRIM(FeeID)[Fee ID], RTRIM(Course)[Course], RTRIM(Branch)[Branch], RTRIM(Year)[Session], RTRIM(Semester)[Semester], RTRIM(TutionFees)[Tution Fees], RTRIM(LibraryFees)[Library Fees], RTRIM(UniversityDevelopmentFees)[University Development Fees], RTRIM(UniversityStudentWelfareFees)[University Student Welfare Fees], RTRIM(CautionMoney)[Caution Money], RTRIM(OtherFees)[Other Fees], RTRIM(TotalFees)[Total Fees] from FeesDetails order by Course,Semester ";
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                frm.TutionFees.Text = dr.Cells[5].Value.ToString();
                frm.LibraryFees.Text = dr.Cells[6].Value.ToString();
                frm.UDFees.Text = dr.Cells[7].Value.ToString();
                frm.USFees.Text = dr.Cells[8].Value.ToString();
                frm.CautionMoney.Text = dr.Cells[9].Value.ToString();
                frm.OtherFees.Text = dr.Cells[10].Value.ToString();
                frm.TotalFees.Text = dr.Cells[11].Value.ToString();
