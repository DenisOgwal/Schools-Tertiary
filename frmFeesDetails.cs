    ...
    public partial class frmFeesDetails : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "insert into FeesDetails(FeeID,Course,Branch,Semester,TutionFees,LibraryFees,UniversityDevelopmentFees,UniversityStudentWelfareFees,CautionMoney,OtherFees,TotalFees,Year) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8,@d9,@d10,@d11,@d12)";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 20, "FeeId"));
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 50, "Course"));
                ...
                cmd.Parameters.Add(new SqlParameter("@d12", System.Data.SqlDbType.NChar, 20, "Year"));
        ...
        private void Update_record_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update feesdetails set Course=@d2,Branch=@d3,Semester=@d4,TutionFees=@d5,LibraryFees=@d6,UniversityDevelopmentFees=@d7,UniversityStudentWelfareFees=@d8,CautionMoney=@d9,OtherFees=@d10,TotalFees=@d11,Year=@d12 where FeeID=@d1";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 20, "FeeId"));
